...
class DeliveredhistoryWidget extends StatefulWidget {
  final Order order;
  DeliveredhistoryWidget({Key key, @required this.order}) : super(key: key);
  @override
  State<StatefulWidget> createState() => OrderItemWidgetState();
}

class OrderItemWidgetState extends StateMVC<DeliveredhistoryWidget> {
            ...
            Container(
                child: Column(
                    children: [
                      ...
                      Text(
                          check
                              ? '${del_address.subLocality},${del_address.locality},${del_address.postalCode}'
                              : '',
                          style: TextStyle(
                      ...
                      Text(
                          check
                              ? '${res_address.subLocality},${res_address.locality},${res_address.postalCode}'
                              : '',
                          style: TextStyle(
                              color: Color(0xff110202),
                              fontWeight: FontWeight.w500)),
